...
const swaggerDefinition = {
    ...
    info: {
        title: "EduForge API",
        version: "1.0.0",
        description: "RESTful API for generating educational math tasks with AI-powered text and image generation using OpenAI's GPT-4o and DALL-E-3.",
        contact: {
            name: "EduForge Team",
        },
        license: {
            ...
            TaskImage: {
                ...
                properties: {
                    ...
                    url: {
                        ...
                        example: "/storage/tasks/task_a1b2c3d4e5f6789012345678901234ab/images/image_x1y2z3a4b5c6789012345678901234xy.png",
                    },
                },
            },
            GenerateTaskRequest: {
