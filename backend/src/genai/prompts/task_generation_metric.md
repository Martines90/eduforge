...
**METRIC SYSTEM** - Use these units and formatting conventions:

**Units to Use:**
- Distance: kilometers (km), meters (m), centimeters (cm), millimeters (mm)
...
- Decimal separator: **comma** → `12,7 km` (NOT 12.7)
- Thousands separator: **space** → `112 233 222` (NOT 112,233,222)

**Examples:**
- `3,98 km` (three point nine eight kilometers)
- `1 250 000 people` (one million two hundred fifty thousand)
- `0,05 seconds` (zero point zero five)
- `15,3 kg` (fifteen point three kilograms)

**Rules:**
- Use metric system throughout the entire task
