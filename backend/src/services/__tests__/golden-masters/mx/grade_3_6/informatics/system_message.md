...
**Topic Hierarchy:**
Creación de Contenido Multimedia > Trabajo con Imágenes Digitales

**Current Topic:**
- **Key:** imagenes_digitales
- **Name:** Trabajo con Imágenes Digitales
- **Description:** Comprender conceptos básicos de imágenes digitales y realizar ediciones simples.
...
```json
{
  ...
  "curriculum_topic": {
    "key": "imagenes_digitales",
    "name": "Trabajo con Imágenes Digitales",
    "short_description": "Comprender conceptos básicos de imágenes digitales y realizar ediciones simples.",
    "example_tasks": []
  },
  "task_id_hint": "imagenes_digitales_generated"
}
```
